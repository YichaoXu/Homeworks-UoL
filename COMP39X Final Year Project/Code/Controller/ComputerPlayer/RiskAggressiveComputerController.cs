...
namespace RiskSrc.Controller.ComputerPlayer {
    ...
    public class RiskAggressiveComputerController :AbstractPlayerController{
        
        public override event PlayerEventDelegate EndTurnEvent;
        
        //Game Model
        private RiskDataManager dataManager;
        private AggressiveComputerCore aiCore;
        
        private RiskViewPlayingCanvas playingCanvas;
        
        private Dictionary<string, int> areaArmiesBalanceDictionary; 
        ...
        public RiskAggressiveComputerController(string playerName):base(playerName) {}
        ...
        protected override IEnumerator StartInitiateCore() {
            ...
            aiCore = new AggressiveComputerCore(playerName);
            var areaName =
        ...
        private string RandomlySelectFirstTerritoryNameFromAllAreas() {
            ...
            return RandomlySelectFirstTerritoryName(fromNameList:allAreasNameList);
        }
        ...
        private string RandomlySelectFirstTerritoryName(List<string> fromNameList) {
            while (true) {
                ...
                var areaName = fromNameList[randomNum];
                if (dataManager.GetOwnerName(areaName) == null) return areaName;
            }
        }
