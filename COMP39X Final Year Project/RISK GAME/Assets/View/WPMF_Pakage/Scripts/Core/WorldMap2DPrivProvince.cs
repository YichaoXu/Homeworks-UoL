...
namespace WPMF
{
	public partial class WorldMap2D : MonoBehaviour
	{
		...
		/// <summary>
		/// Used internally by the GameMap Editor. It will recalculate de boundaries and optimize frontiers based on new data of provinces array
		/// </summary>
		...
		/// <summary>
		/// Unpacks province geodata information. Used by GameMap Editor.
		/// </summary>
...
//				mr.useLightProbes = false;
	...
	#region Province highlighting
		...
		/// Internally used by the GameMap UI and the Editor component, but you can use it as well to temporarily mark a country region.
		/// </summary>
