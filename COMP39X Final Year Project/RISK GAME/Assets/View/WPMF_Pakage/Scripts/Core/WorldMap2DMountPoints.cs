...
namespace WPMF {
	...
	#region Drawing stuff
		...
		/// <summary>
		/// Redraws the mounts points but only in editor time. This is automatically called by Redraw(). Used internally by the GameMap Editor. You should not need to call this method directly.
		/// </summary>
